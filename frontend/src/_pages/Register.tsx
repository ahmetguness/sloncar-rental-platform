                ...
                <div className="bg-white p-6 md:p-10 rounded-3xl shadow-2xl shadow-black/5 border border-[#E5E5E5]">
                    ...
                    <div className="flex bg-[#F5F5F5] rounded-xl p-1 mb-6 border border-[#E5E5E5]">
                        <button
                            ...
                            className={`flex-1 py-2.5 text-sm font-bold rounded-lg transition-all ${membershipType === 'INDIVIDUAL'
                        ...
                        <button
                            ...
                            className={`flex-1 py-2.5 text-sm font-bold rounded-lg transition-all ${membershipType === 'CORPORATE'
                                    ? 'bg-white text-primary-500 shadow-sm'
                                    : 'text-[#999999] hover:text-[#777777]'
                                }`}
                        >
