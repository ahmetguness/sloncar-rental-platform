                                    ...
                                    <div className="p-1">
                                        {currentUser?.role === 'ADMIN' && (
                                            <>
                                                ...
                                                <Link href="/admin/audit-logs" onClick={() => setIsSystemMenuOpen(false)}>
                                                ...
                                                <Link href="/admin/users" onClick={() => setIsSystemMenuOpen(false)}>
                                                    <button className="w-full flex items-center gap-2 px-3 py-2 text-sm text-gray-600 hover:text-[#111111] hover:bg-black/5 rounded-lg transition-colors text-left">
                                                        <Users className="w-4 h-4 text-emerald-500" />
                                                        Yöneticiler
                                                    </button>
                                                </Link>
                                                <Link href="/admin/backup" onClick={() => setIsSystemMenuOpen(false)}>
                                                    <button className="w-full flex items-center gap-2 px-3 py-2 text-sm text-gray-600 hover:text-[#111111] hover:bg-black/5 rounded-lg transition-colors text-left">
