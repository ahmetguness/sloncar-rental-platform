...
export const CarDetail = () => {
    ...
    if (loading) return (
        <div className="min-h-screen flex flex-col items-center justify-center">
            ...
            <p className="text-[#777777]">Araç detayları yükleniyor...</p>
        </div>
    );
    ...
    return (
        <div className="min-h-screen pt-24 pb-20 px-4 md:px-8">
            <div className="container mx-auto max-w-7xl">
                {/* Back Button */}
                <Link to="/second-hand" className="inline-flex items-center gap-2 text-[#777777] hover:text-[#111111] mb-8 transition-colors">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start mb-12">
                    ...
                    <div className="lg:col-span-4 space-y-6">
                        <div className="bg-[#F5F5F5] rounded-[2.5rem] p-5 sm:p-8 border border-[#E5E5E5] shadow-2xl relative overflow-hidden group">
                            ...
                            <div className="space-y-4 mb-8">
                                <h1 className="text-2xl sm:text-4xl font-black text-[#111111] tracking-tighter">
                                    {car.brand} <span className="text-primary-500">{car.model}</span>
                                </h1>
                                <div className="flex flex-wrap items-center gap-3">
                                    <span className="bg-[#F5F5F5] text-[#777777] px-3 py-1 rounded-lg text-xs font-bold border border-[#E5E5E5]">{car.year}</span>
                                    <span className="bg-[#F5F5F5] text-[#777777] px-3 py-1 rounded-lg text-xs font-bold border border-[#E5E5E5]">{car.mileage.toLocaleString()} KM</span>
                                </div>
                            </div>

                            <div className="bg-[#222222] rounded-3xl p-4 sm:p-6 border border-[#333333] mb-6 sm:mb-8">
                                <p className="text-[10px] text-gray-400 font-black uppercase tracking-[0.2em] mb-2">Satış Fiyatı</p>
                ...
                <div className="w-full bg-[#F5F5F5] border-y border-[#E5E5E5] py-4 sm:py-6 px-4 sm:px-8 mb-8 sm:mb-12 grid grid-cols-2 sm:flex sm:flex-wrap items-center justify-between gap-4 sm:gap-8 rounded-[1.5rem]">
                    {[
                        ...
                        <div key={i} className="flex items-center gap-4 group">
                            ...
                            <div>
                                ...
                                <p className="font-bold text-[#111111] text-sm capitalize">{spec.value}</p>
                            </div>
                        </div>
                    ))}
                </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-16">
                    ...
                    <div className="space-y-6">
                        <div className="flex items-center gap-4">
                            <h3 className="text-xl font-black text-[#111111] uppercase tracking-tight">Hasar <span className="text-primary-500">Durumu</span></h3>
                            <div className="h-px flex-1 bg-[#E5E5E5]" />
                        </div>
                        <div className="bg-[#F5F5F5] rounded-[2.5rem] p-4 sm:p-10 border border-[#E5E5E5] flex items-center justify-center relative group min-h-[400px] sm:min-h-[500px]">
                    ...
                    <div className="space-y-8">
                        <div className="flex items-center gap-4">
                            <h3 className="text-xl font-black text-[#111111] uppercase tracking-tight">Ekspertiz <span className="text-primary-500">Notları</span></h3>
                            <div className="h-px flex-1 bg-[#E5E5E5]" />
                        </div>

                        <div className="bg-[#F5F5F5] rounded-[2.5rem] p-5 sm:p-8 border border-[#E5E5E5]">
                            <p className="text-[#777777] italic leading-relaxed text-lg">
                        ...
                        <div>
                            ...
                            <div className="flex flex-wrap gap-2">
                                {car.features?.map((f, i) => (
                                    <span key={i} className="text-xs bg-primary-500/10 text-primary-500 px-4 py-2 rounded-xl font-bold border border-primary-500/20 flex items-center gap-2">
                ...
                {car.description && (
                    <div className="space-y-6 max-w-4xl">
                        <div className="flex items-center gap-4">
                            <h3 className="text-xl font-black text-[#111111] uppercase tracking-tight">Genel <span className="text-primary-500">Açıklama</span></h3>
                            <div className="h-px flex-1 bg-[#E5E5E5]" />
                        </div>
                        <p className="text-[#777777] text-lg leading-relaxed whitespace-pre-wrap">
                            {car.description}
                        </p>
                    </div>
                )}
