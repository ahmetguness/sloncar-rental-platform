...
const API_URL = process.env.NEXT_PUBLIC_API_URL || process.env.VITE_API_URL || 'http://localhost:3000/api';
...
export const adminService = {
    ...
    markNotificationRead: async (id: string, type: 'booking' | 'franchise' | 'insurance') => {
